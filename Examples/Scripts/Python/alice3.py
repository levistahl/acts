...
def buildALICE3Geometry(
    ...
    matDeco = None
    if material:
        file = geo_dir / "geometry-map.json"
    ...
    return TGeoDetector.create(
        ...
        mdecorator=matDeco,
        buildBeamPipe=True,
        unitScalor=10.0,  # explicit unTRK
        ...
        volumes=[
            ...
            Volume(
                ...
                sensitiveAxes=LayerTriplet("XYZ"),
                rRange=LayerTriplet(
                    negative=(45 * u.mm, 1000 * u.mm),
                    positive=(45 * u.mm, 1000 * u.mm),
                ),
                zRange=LayerTriplet(
                    negative=(-3600 * u.mm, -1400 * u.mm),
                    positive=(1400 * u.mm, 3600 * u.mm),
                ),
                splitTolR=LayerTriplet(-1.0),
                splitTolZ=LayerTriplet(negative=5 * u.mm, positive=5 * u.mm),
                binning0=LayerTriplet(
